...
import { LLM_VIZ_ASSET_BASE, fetchJsonAsset, fetchRequiredAsset } from "@/src/utils/assetBase";
...
export async function fetchFontAtlasData(signal?: AbortSignal): Promise<IFontAtlasData> {
