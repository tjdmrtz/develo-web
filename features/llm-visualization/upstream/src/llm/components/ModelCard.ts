...
import { DEVELO_LLM_VIZ_THEME } from "../../../../theme";

function withAlpha(color: Vec4, alpha: number) {
...
export function renderInputBoxes(state: IProgramState, layout: IGptModelLayout, tl: Vec3, br: Vec3, cellW: number, fontSize: number, lineOpts: ILineOpts, opts?: IInputBoxOpts) {
    ...
    let tokTextOpts: IFontOpts = { color: DEVELO_LLM_VIZ_THEME.text, mtx: lineOpts.mtx, size: fontSize };
    let idxTextOpts: IFontOpts = { color: DEVELO_LLM_VIZ_THEME.muted, mtx: lineOpts.mtx, size: fontSize * 0.6 };
...
export function renderOutputBoxes(state: IProgramState, layout: IGptModelLayout, tl: Vec3, br: Vec3, cellW: number, fontSize: number, lineOpts: ILineOpts, opts?: IOutputBoxOpts) {
    ...
    let tokTextOpts: IFontOpts = { color: withAlpha(DEVELO_LLM_VIZ_THEME.text, opacity), mtx: lineOpts.mtx, size: fontSize };
    let idxTextOpts: IFontOpts = { color: withAlpha(DEVELO_LLM_VIZ_THEME.muted, opacity), mtx: lineOpts.mtx, size: fontSize * 0.6 };
...
function renderInputAtTop(state: IProgramState) {
    ...
    let titleTextOpts: IFontOpts = { color: DEVELO_LLM_VIZ_THEME.muted, mtx: lineOpts.mtx, size: 1.9 };
