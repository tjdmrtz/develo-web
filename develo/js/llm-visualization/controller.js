...
export class DeveloLlmVizController {
  ...
  bindLifecycle() {
    ...
    this.intersectionObserver = new IntersectionObserver((entries) => {
      ...
      const marginHit = entry.isIntersecting || rect.top < (window.innerHeight + 800);
      if (marginHit && !this.loadStarted) this.beginLoad();
  ...
  async beginLoad() {
    ...
    try {
      ...
      this.progState.stage = this.reducedMotion ? "idle" : "tokens";
